          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="glass-card p-5 rounded-2xl border border-white/5 relative overflow-hidden group">
              ...
              <div className="text-2xl font-black text-white">
                {dashboardStats.netWorth > 0 ? `${dashboardStats.netWorth.toLocaleString("es-ES")} €` : "-- €"}
              </div>
              <div className="text-[10px] text-white/30 mt-1 flex items-center gap-1">
                <Activity className="w-3 h-3" /> Basado en última carga
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.1 }} className="glass-card p-5 rounded-2xl border border-white/5 relative overflow-hidden group">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">Capacidad de Ahorro</span>
              </div>
              <div className="text-2xl font-black text-white">
                {dashboardStats.monthlyIncome > 0 ? `${(dashboardStats.monthlyIncome - dashboardStats.monthlyExpenses).toLocaleString("es-ES")} €/mes` : "-- €"}
              </div>
              <div className="text-[10px] text-white/30 mt-1 flex items-center gap-1">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="glass-card p-5 rounded-2xl border border-white/5 relative overflow-hidden group">
