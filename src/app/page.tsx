...
const DemoShowcase = () => {
  ...
  const chatData = {
    realestate: [
      { from: 'bot', text: '¡Hola! Bienvenido a Inmobiliaria Hec. ¿Buscas comprar o alquilar?' },
      { from: 'user', text: 'Hola, busco alquilar un piso de 2 habitaciones.' },
      { from: 'bot', text: '¡Entendido! Tengo 3 opciones disponibles en tu zona. ¿Te gustaría ver fotos o agendar una visita?' },
      { from: 'user', text: 'Agendar visita para el sábado.' },
      { from: 'bot', text: 'Perfecto. Sábado a las 11:00 AM está libre. ¿Confirmo tu cita? 🗓️' },
    ],
    ecommerce: [
      { from: 'bot', text: '👋 Hola. Veo que estás mirando las Zapatillas Runner X.' },
      { from: 'user', text: 'Sí, pero no sé qué talla elegir.' },
      { from: 'bot', text: 'No te preocupes. Según tus compras anteriores, eres talla 42. Además, ¡hoy tienen un 20% de descuento!' },
    ...
    health: [
      ...
      { from: 'bot', text: 'Viernes 10:00 AM reservado. ✅' },
    ],
    resto: [
      { from: 'bot', text: '¡Bienvenido a BurgerTech! 🍔 ¿Mesa para comer o delivery?' },
      { from: 'user', text: 'Mesa para 4 personas.' },
      { from: 'bot', text: '¿Para hoy?' },
      { from: 'user', text: 'Sí, a las 21:00.' },
      { from: 'bot', text: '¡Hecho! Mesa reservada. Tenemos 2x1 en cervezas. 🍻' },
    ],
  };
